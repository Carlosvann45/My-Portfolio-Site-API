...
Routes.TECH_ROUTE = `${_a.DEFAULT_ROUTE}/technologies`;
Routes.TECH_ID_ROUTE = `${_a.TECH_ROUTE}/:id`;
...
Errors.TECH_REQUIRED = 'All fields in technology are required and links must be valid.';
Errors.TECH_NOT_FOUND = 'Technology with given id does not exists.';
