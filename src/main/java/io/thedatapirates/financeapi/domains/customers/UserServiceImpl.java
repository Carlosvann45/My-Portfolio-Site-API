...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    /**
     * Gets a user from the user repository by username
     *
    ...
    public User getUser(String email, String token) {
        ...
        if (user == null) {
            throw new NotFound(StringConstants.USER_NOT_FOUND);
        } else if (!Objects.equals(user.getEmail(), actualEmail)) {
     ...
     */
    @Override
    public JwtResponse refreshUserToken(String refreshToken, String url) {
        String token = null;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (user == null) {
            user = new User(StringConstants.EMPTY_STRING, StringConstants.EMPTY_STRING);
        }
