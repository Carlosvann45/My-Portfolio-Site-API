...
import io.thedatapirates.financeapi.domains.customers.UserServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity security) throws Exception {
        ...
        customAuthFilter.setFilterProcessesUrl(Paths.USERS_PATH.concat(Paths.LOGIN_PATH));

        security.csrf().disable();

        security.authorizeRequests()
                .antMatchers(GET, Paths.USERS_PATH.concat(Paths.REFRESH_TOKEN_PATH))
                .permitAll();
